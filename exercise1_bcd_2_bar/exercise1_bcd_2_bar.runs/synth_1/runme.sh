...
HD_PWD='C:/vhdl/exercise1_bcd_2_bar/exercise1_bcd_2_bar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_2_bar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_2_bar.tcl
