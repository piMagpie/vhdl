...
HD_PWD='C:/vhdl/exercise_6_temperature/exercise_6_temperature.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Temperature_Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Temperature_Controller.tcl
