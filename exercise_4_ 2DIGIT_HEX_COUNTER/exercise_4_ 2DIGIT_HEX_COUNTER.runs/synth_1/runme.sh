...
HD_PWD='C:/vhdl/exercise_4_ 2DIGIT_HEX_COUNTER/exercise_4_ 2DIGIT_HEX_COUNTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIGIT_HEX_COUNTER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIGIT_HEX_COUNTER.tcl
